...
| [`context-fit-work.md`](context-fit-work.md) | **CF** — the context-fit arc: measure each model's maximum context, gate benchmarks on it, apply it to LoadCoach, spill past it (rows CF1–CF7) | 2026-09-13 | Built 2026-09-13 on `row/cf-context-fit` in three worktrees (`history/handoffs/CF_HANDOFF.md`) |
