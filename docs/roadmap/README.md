...
| [`wx-console-ux-work.md`](wx-console-ux-work.md) | **WX** — the console experience arc: the operator's 2026-09-12 request list (sixty items over the five tabs) grouped by collision into rows WX1–WX14, four waves | 2026-09-12 | Planned 2026-09-12 after four surveys; **waves 1 and 2 (WX1–WX7, WX9–WX11) done and merged 2026-09-12/13**; wave 3 (WX8, WX12, WX13, WX15) dispatched 2026-09-13 |
