...
| [`wx-console-ux-work.md`](wx-console-ux-work.md) | **WX** — the console experience arc: the operator's 2026-09-12 request list (sixty items over the five tabs) grouped by collision into rows WX1–WX14, four waves | 2026-09-12 | Planned 2026-09-12 after four surveys; **wave 1 (WX1–WX6) done and merged the same day**; wave 2 (WX7, WX9–WX11) dispatched |
