...
| [`wy-console-polish-work.md`](wy-console-polish-work.md) | **WY** — the console polish arc: the operator's second 2026-09-12 request list (21 items) as nine build rows in two waves plus one merge row (WY1–WY10) | 2026-09-12 | Planned 2026-09-12; kickoffs `history/prompts/wy*.prompt.md`; waiting on the operator committing the eight uncommitted template edits on `main` (§0) |
