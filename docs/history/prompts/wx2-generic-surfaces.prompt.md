# Kickoff — Row WX2: Generic surfaces

**Row:** `WX2` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** WeightRoom. **Worktree(s):** ~/ai/worktrees/weightroom-wx2 (branch row/wx2-generic-surfaces). **Throwaway console port:** 8789 / trust 8790.
...
`WeightRoom/docs/history/handoffs/WX2_HANDOFF.md` written on **your WeightRoom branch** (or,
