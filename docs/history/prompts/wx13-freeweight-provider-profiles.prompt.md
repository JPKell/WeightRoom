# Kickoff — Row WX13: FreeWeight provider profiles

**Row:** `WX13` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** FreeWeight, then WeightRoom. **Worktree(s):** ~/ai/worktrees/freeweight-wx13 (branch row/wx13-provider-profiles) and ~/ai/worktrees/weightroom-wx13 (branch row/wx13-provider-profiles). **Throwaway console port:** 8799 / trust 8800; FreeWeight serve on 18766 (fake provider) if wanted.
...
`WeightRoom/docs/history/handoffs/WX13_HANDOFF.md` written on **your WeightRoom branch** (or,
