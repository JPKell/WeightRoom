# Kickoff — Row WX12: IdeaPress editable workflows

**Row:** `WX12` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** IdeaPress, then WeightRoom. **Worktree(s):** ~/ai/worktrees/ideapress-wx12 (branch row/wx12-workflows) and ~/ai/worktrees/weightroom-wx12 (branch row/wx12-workflow-editor). **Throwaway console port:** 8789 / trust 8790; IdeaPress serve on 18767 (fake/loadcoach-less mode) if wanted.
...
`WeightRoom/docs/history/handoffs/WX12_HANDOFF.md` written on **your WeightRoom branch** (or,
