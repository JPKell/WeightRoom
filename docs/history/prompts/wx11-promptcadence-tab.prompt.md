# Kickoff — Row WX11: PromptCadence tab

**Row:** `WX11` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** WeightRoom. **Worktree(s):** ~/ai/worktrees/weightroom-wx11 (branch row/wx11-promptcadence-tab). **Throwaway console port:** 8809 / trust 8810.
...
`WeightRoom/docs/history/handoffs/WX11_HANDOFF.md` written on **your WeightRoom branch** (or,
