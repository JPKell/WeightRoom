# Kickoff — Row WX10: IdeaPress tab

**Row:** `WX10` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** WeightRoom. **Worktree(s):** ~/ai/worktrees/weightroom-wx10 (branch row/wx10-ideapress-tab). **Throwaway console port:** 8799 / trust 8800.
...
`WeightRoom/docs/history/handoffs/WX10_HANDOFF.md` written on **your WeightRoom branch** (or,
