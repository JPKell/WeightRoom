# Kickoff — Row WX15: The PostgreSQL bootstrap script

**Row:** `WX15` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** WeightRoom. **Worktree(s):** ~/ai/worktrees/weightroom-wx15 (branch row/wx15-postgres-script). **Throwaway console port:** 8809 / trust 8810.
...
`WeightRoom/docs/history/handoffs/WX15_HANDOFF.md` written on **your WeightRoom branch** (or,
