# Kickoff — Row WX9: LoadCoach tab

**Row:** `WX9` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** LoadCoach, then WeightRoom. **Worktree(s):** ~/ai/worktrees/loadcoach-wx9 (branch row/wx9-provider-enabled) and ~/ai/worktrees/weightroom-wx9 (branch row/wx9-loadcoach-tab). **Throwaway console port:** 8789 / trust 8790; LoadCoach serve on 18766 if wanted (fake provider only).
...
`WeightRoom/docs/history/handoffs/WX9_HANDOFF.md` written on **your WeightRoom branch** (or,
