# Kickoff — Row WX6: ECharts in MirrorWall

**Row:** `WX6` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** MirrorWall, then WeightRoom. **Worktree(s):** ~/ai/worktrees/mirrorwall-wx6 (branch row/wx6-echarts) and ~/ai/worktrees/weightroom-wx6 (branch row/wx6-echarts). **Throwaway console port:** 8829 / trust 8830.
...
`WeightRoom/docs/history/handoffs/WX6_HANDOFF.md` written on **your WeightRoom branch** (or,
