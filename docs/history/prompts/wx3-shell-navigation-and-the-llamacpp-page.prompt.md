# Kickoff — Row WX3: Shell navigation and the llama.cpp page

**Row:** `WX3` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** WeightRoom. **Worktree(s):** ~/ai/worktrees/weightroom-wx3 (branch row/wx3-shell-nav). **Throwaway console port:** 8799 / trust 8800.
...
`WeightRoom/docs/history/handoffs/WX3_HANDOFF.md` written on **your WeightRoom branch** (or,
