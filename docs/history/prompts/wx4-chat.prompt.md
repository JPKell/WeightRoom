# Kickoff — Row WX4: Chat

**Row:** `WX4` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** WeightRoom. **Worktree(s):** ~/ai/worktrees/weightroom-wx4 (branch row/wx4-chat). **Throwaway console port:** 8809 / trust 8810.
...
`WeightRoom/docs/history/handoffs/WX4_HANDOFF.md` written on **your WeightRoom branch** (or,
