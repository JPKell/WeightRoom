# Kickoff — Row WX5: Pagination

**Row:** `WX5` in [`docs/roadmap/wx-console-ux-work.md`](../../roadmap/wx-console-ux-work.md) §1 — the
...
**Repositories:** PromptCadence, then WeightRoom. **Worktree(s):** ~/ai/worktrees/promptcadence-wx5 (branch row/wx5-ledger-cursor) and ~/ai/worktrees/weightroom-wx5 (branch row/wx5-pagination). **Throwaway console port:** 8819 / trust 8820; PromptCadence serve on 18768 if needed.
...
`WeightRoom/docs/history/handoffs/WX5_HANDOFF.md` written on **your WeightRoom branch** (or,
